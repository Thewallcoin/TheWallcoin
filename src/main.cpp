...
unsigned int nTargetSpacing = 64; //Block  spacing 2 minute
unsigned int nStakeMinAge = 8 * 60 * 60 ; //Minimum stake age 8
unsigned int nStakeMaxAge = 24 * 60 * 60 * 45; //Maximum stake age 45days

unsigned int nModifierInterval = 10 * 60; // time to elapse before new modifier is computed

int nCoinbaseMaturity = 10; //Coin Base Maturity
...
const string strMessageMagic = "TheWallCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            int64_t nSubsidy = 100 * COIN; //Miner reward

            if(nBestHeight == 0)
            {
            nSubsidy = 10000000 * COIN; //Total premine coin
            }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TheWallCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "2017-11-09";
        CTransaction txNew;
        txNew.nTime = 1510213369;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1510213369;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 4725132 : 4725132;
        ...
        assert(block.hashMerkleRoot == uint256("0x0f307ace79bc5455e25ae477814cf7cf8d9e9130182042b3678d28635ec419e6"));
