...
#OPENSSL_INCLUDE_PATH=/opt/openssl_static/include
#OPENSSL_LIB_PATH=/opt/openssl_static/lib
...
contains(RELEASE, 1) {
    ...
    !windows:!macx {
        # Linux: static link
        message(Building RELEASE static)
        LIBS += -Wl,-Bstatic
    }
}
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README res/bitcoin-qt.rc
